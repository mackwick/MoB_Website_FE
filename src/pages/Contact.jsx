  ...
  return (
    <div className="contact-container">
      ...
      <div className="how-to-involved">
        ...
        <h4>AUDITION</h4>
        <p>
          Email us (info above and below) if you're interested in participating
          in an upcoming project! You can also follow us on social media, where
          we announce auditions.
        </p>
        <h4>ETC.</h4>
        <p>
          We still encourage those If you are not local to North Carolina, but
          still wish to engage with MoB, follow us on our social media. We often
          post when we are seeking interviews for our documentary productions,
          which is a unique opportunity MoB offers to become involved in our
          productions!
        </p>
      </div>
    </div>
